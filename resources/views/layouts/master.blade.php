                    ...
                    <div class="nav">
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('sembako.index','semua')}}">Semua Barang</a>
                                    <a class="nav-link" href="{{route('sembako.index','3_hari_lagi')}}">Barang Kadaluwarsa</a>
                                    <a class="nav-link" href="{{ route('sembako.create') }}">Input Barang</a>
                                </nav>
                            </div>
                        </nav>
                    </div>
